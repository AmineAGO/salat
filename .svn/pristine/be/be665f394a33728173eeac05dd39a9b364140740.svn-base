...
public class IkamaPanel extends JPanel {
    ...
    public JPanel mettreEnForme(ImageIcon image,int nbmin, int hEcran) {
       
                
    	IkamaPanel panel = new IkamaPanel ();
            	...
            	new CompteARIkama(panel,image,nbmin);
